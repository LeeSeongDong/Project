...
public class MorphMatcher 
{
   ...
   public String match(String inputText)
   {
      ...
      ArrayList<String> arr = fileLoad("C://Users//LSD//L//기타자료//SIG자료//16_여름//데이터들//Trainingset//" + inputText.charAt(0) + ".txt");
      ArrayList<Data> recommendation = new ArrayList<Data>();
      ...
      for(int i = 0; i < size; ++i)
      {
         ...
         double wed = weda.getEditDistance(inputText, temp);
         if(wed < str.length())
         {
            Data d = new Data(wed, temp);
            recommendation.add(d);
         }
         
         if(inputText.equals(temp))
         {
            flag = true;
            msgList.add("은/는 올바른 어절구성입니다.");
            for(int j = 0; j < 3; ++j)
            {
               msgList.add("@@## ");
            }
